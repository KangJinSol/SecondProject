...
<script>
	function update_member(obj) {
		...
		$.ajax({
			url : "<%=request.getContextPath()%>/admin/process/ajax_update_member.jsp",
			data : data,
			method:"get",
			success:function(d){
				d = Boolean(d);
	...
	function delete_member(obj) {
		...
		console.log(data);
		$.ajax({
			url : "<%=request.getContextPath()%>/admin/process/ajax_delete_member.jsp",
			data : data,
			method:"get",
			success:function(d){
				d = Boolean(d);
	...
	$(function() {
		$("#btn_submit").click(function(e) {
			...
			$.ajax({
				url : "<%=request.getContextPath()%>/admin/process/ajax_search_process",
				data : data,
				method : 'get',
				success : function(d) {
					console.log(d);
